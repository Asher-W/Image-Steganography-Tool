...
def get_pseudorandom(seed, base, top):
    ...
    # remove the 0b string from the beginning of the binary string
    seed_binary = bin(seed)[2:]
    top_binary = bin(top)[2:]

    # make sure both strings are the same length, and add to the beginning of the shorter one
    ...
    # preform and XOR function on the top and seed binary
    return_num = ""
